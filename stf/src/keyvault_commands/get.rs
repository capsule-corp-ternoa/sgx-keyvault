...
use substratee_client_primitives::common_args::{add_url_arg, add_nft_id_arg, add_account_id_arg, URL_ARG_NAME};
...
///         owner
///         enclave url
pub fn keyvault_get_cli_command() -> Command<'static, str> {
    Command::new("get")
