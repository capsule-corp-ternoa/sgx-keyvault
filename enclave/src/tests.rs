...
pub extern "C" fn test_main_entrance() -> size_t {
    rsgx_unit_tests!(
        ...
        rpc::io_handler_extensions::tests::test_given_io_handler_methods_then_retrieve_all_names_as_string,
        rpc::rpc_call_encoder::tests::test_encoding_none_params_returns_ok,
        rpc::rpc_keyvault_check::tests::test_given_valid_top_returns_true,
        rpc::rpc_keyvault_check::tests::test_given_valid_top_returns_true,
        rpc::rpc_keyvault_check::tests::test_given_wrong_getter_returns_error,
        rpc::rpc_keyvault_get::tests::test_given_valid_top_returns_shares,
        rpc::rpc_keyvault_get::tests::test_given_wrong_top_returns_error,
        rpc::rpc_keyvault_get::tests::test_given_wrong_getter_returns_error,
        rpc::rpc_keyvault_provision::tests::test_given_valid_top_returns_ok,
        rpc::rpc_keyvault_provision::tests::test_given_wrong_top_returns_error,
        rpc::rpc_keyvault_provision::tests::test_given_indirect_top_returns_error,
        rpc::trusted_operation_verifier::tests::given_valid_operation_in_request_then_decrypt_succeeds,
        rpc::trusted_operation_verifier::tests::given_nonsense_text_in_request_then_decode_fails,
        rpc::trusted_operation_verifier::tests::given_valid_operation_with_invalid_signature_then_return_error,
        ...
        ternoa::keyvault::test::test_ensure_dir_exists_creates_new_if_not_existing,
        ternoa::keyvault::test::test_sealed_file_name_contains_nftid,
        ternoa::keyvault::test::test_seal_create_file,
        ternoa::keyvault::test::test_share_saved_in_sealed_file,
        ternoa::keyvault::test::test_seal_override_existing_sealed_file,
        ternoa::keyvault::test::test_unseal_fails_when_no_file_exists,
        ternoa::keyvault::test::test_provision_store_share_in_sealed_file,
        ternoa::keyvault::test::test_check_is_true_when_sealed_file,
        ternoa::keyvault::test::test_check_is_false_when_no_sealed_file,
        ternoa::keyvault::test::test_get_none_when_nft_not_in_store,
        ternoa::keyvault::test::test_get_the_valid_stored_share,
